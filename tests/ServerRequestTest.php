...
class ServerRequestTest extends \PHPUnit_Framework_TestCase
{
    public function dataNormalizeFiles()
    {
        return [
            'Single file' => [
                ...
                [
                    'file' => new \GuzzleHttp\Psr7\UploadedFile(
                        '/tmp/php/php1h4j1o',
                        123,
                        UPLOAD_ERR_OK,
                        'MyFile.txt',
            ...
            'Empty file' => [
                ...
                [
                    'image_file' => new \GuzzleHttp\Psr7\UploadedFile(
                        '',
                        0,
                        UPLOAD_ERR_NO_FILE,
                        '',
            ...
            'Already Converted array' => [
                [
                    'file' => [
                        new \GuzzleHttp\Psr7\UploadedFile(
                            '/tmp/php/php1h4j1o',
                            123,
                            UPLOAD_ERR_OK,
                            'MyFile.txt',
            ...
            'Multiple files' => [
                ...
                [
                    'text_file' => new \GuzzleHttp\Psr7\UploadedFile(
                        '/tmp/php/php1h4j1o',
                        123,
                        UPLOAD_ERR_OK,
                        'MyFile.txt',
            ...
            'Nested files' => [
                ...
                [
                    'file' => [
                        0 => new \GuzzleHttp\Psr7\UploadedFile(
                            '/tmp/php/hp9hskjhf',
                            123,
                            UPLOAD_ERR_OK,
                            'MyFile.txt',
                        ...
                        1 => new \GuzzleHttp\Psr7\UploadedFile(
                            '/tmp/php/php1h4j1o',
                            7349,
                            UPLOAD_ERR_OK,
                            'Image.png',
                    ...
                    'nested' => [
                        'other' => new \GuzzleHttp\Psr7\UploadedFile(
                            '/tmp/php/hp9hskjhf',
                            421,
                            UPLOAD_ERR_OK,
                            'Flag.txt',
    ...
    {
        $result = \CFX\ServerRequest::normalizeFiles($files);
    ...
    public function testNormalizeFilesRaisesException()
    {
        ...
        \CFX\ServerRequest::normalizeFiles(['test' => 'something']);
    }
    ...
    public function testGetUriFromGlobals($expected, $serverParams)
    {
        ...
        $this->assertEquals(new \GuzzleHttp\Psr7\Uri($expected), \CFX\ServerRequest::getUriFromGlobals());
    }
    ...
    public function testFromGlobals()
    {
        ...
        $server = \CFX\ServerRequest::fromGlobals();
        ...
        $this->assertEquals(
            new \GuzzleHttp\Psr7\Uri('https://www.example.org/blog/article.php?id=10&user=foo'),
            $server->getUri()
        );
    ...
    {
        $request1 = new \CFX\ServerRequest('GET', '/');

        $files = [
            'file' => new \GuzzleHttp\Psr7\UploadedFile('test', 123, UPLOAD_ERR_OK)
        ];
    ...
    public function testServerParams()
    {
        ...
        $request = new \CFX\ServerRequest('GET', '/', [], null, '1.1', $params);
    ...
    {
        $request = (new \CFX\ServerRequest('GET', '/'))->withAttribute('name', null);
